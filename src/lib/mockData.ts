...
export const busesMock: Bus[] = [
  { id: 'b1', rutaNombre: 'C12', lat: 10.972, lng: -74.795 },
  { id: 'b2', rutaNombre: 'A8', lat: 10.991, lng: -74.802 },
  { id: 'b3', rutaNombre: 'T1', lat: 10.963, lng: -74.781 },
  { id: 'b4', rutaNombre: 'B1', lat: 10.978, lng: -74.788 },
  { id: 'b5', rutaNombre: '46', lat: 10.955, lng: -74.776 },
];
